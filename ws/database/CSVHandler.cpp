...
std::string CSVHandler::writeArray(const ArrayType &arr) {
    std::stringstream ss;
    ss << "[";
...
void CSVHandler::serializeExtendedPayloadP2(const T payload, const CCSDS_Packet &packet, std::ofstream &file) {
    file << writeArray(payload.CameraPacket2) << ",";
    file << writeArray(payload.CameraPacket3) << ",";
    ...
    file << writeArray(payload.respart2_2) << ",";
