...
template<typename T>
void CSVHandler::serializeExtendedPayloadP1(const T payload, const CCSDS_Packet &packet) {
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP2(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP3(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP4(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP5(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP6(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP7(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP8(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP9(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP10(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP11(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP12(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP13(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP14(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP15(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP16(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP17(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP18(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP19(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP20(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP21(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP22(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP23(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP24(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP25(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP26(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP27(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
...
template<typename T>
void CSVHandler::serializeExtendedPayloadP28(const T payload, const CCSDS_Packet &packet) {
    mongocxx::collection collection;
